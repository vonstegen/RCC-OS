...
\begin{lstlisting}[language=json,caption={Request envelope.}]
{
  "id": "<uuidv7>",
  "ts": "<rfc3339>",
  "type": "request",
...
\begin{lstlisting}[language=json,caption={Response envelope.}]
{
...
\begin{lstlisting}[language=json,caption={Capability execute body.}]
{
...
\begin{lstlisting}[language=json,caption={Cognitive Core request.}]
{
  "task": "route",
...
\begin{lstlisting}[language=json,caption={Cognitive Core response.}]
{
...
\begin{lstlisting}[language=json,caption={Hardware profile.}]
{
  "arch": "aarch64",
  "os": "macos",
  "os_version": "15.4",
...
\begin{lstlisting}[language=python,caption={Model tier selector (pseudocode).]
