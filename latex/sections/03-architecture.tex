...
\begin{lstlisting}[language=json,caption={Example request to the Cognitive Core.}]
{
  "task": "route",
...
\begin{lstlisting}[language=json,caption={Example response from the Cognitive Core.}]
{
